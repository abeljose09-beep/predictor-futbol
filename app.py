...
# ─── MUNDIAL 2026 DATA ─────────────────────────────────────────────────────────
MUNDIAL_2026_GRUPOS = {
    "Grupo A": ["México", "Ecuador", "Alemania", "Japón"],
    "Grupo B": ["Argentina", "Chile", "Marruecos", "Ucrania"],
    "Grupo C": ["Brasil", "Colombia", "Nigeria", "Japón"],
    "Grupo D": ["Francia", "Bélgica", "Irán", "Senegal"],
    "Grupo E": ["España", "Croacia", "Camerún", "Arabia Saudita"],
    "Grupo F": ["Inglaterra", "Portugal", "Argelia", "Canadá"],
    "Grupo G": ["Estados Unidos", "Uruguay", "Turquía", "Tailandia"],
    "Grupo H": ["Países Bajos", "Polonia", "Perú", "Corea del Sur"],
    "Grupo I": ["Italia", "Suiza", "Sudáfrica", "Ghana"],
    "Grupo J": ["Australia", "Serbia", "Jamaica", "Venezuela"],
    "Grupo K": ["Austria", "Rumania", "Honduras", "Togo"],
    "Grupo L": ["Nueva Zelanda", "Kenia", "Grecia", "Panamá"],
}
...
EMOJIS_SELECCIONES = {
    ...
    "Brasil": "🇧🇷", "Colombia": "🇨🇴", "Nigeria": "🇳🇬",
    "Francia": "🇫🇷", "Bélgica": "🇧🇪", "Irán": "🇮🇷", "Senegal": "🇸🇳",
    "España": "🇪🇸", "Croacia": "🇭🇷", "Camerún": "🇨🇲", "Arabia Saudita": "🇸🇦",
    "Inglaterra": "🏴󠁧󠁢󠁥󠁮󠁧󠁿", "Portugal": "🇵🇹", "Argelia": "🇩🇿", "Canadá": "🇨🇦",
    "Estados Unidos": "🇺🇸", "Uruguay": "🇺🇾", "Turquía": "🇹🇷", "Tailandia": "🇹🇭",
    "Países Bajos": "🇳🇱", "Polonia": "🇵🇱", "Perú": "🇵🇪", "Corea del Sur": "🇰🇷",
    "Italia": "🇮🇹", "Suiza": "🇨🇭", "Sudáfrica": "🇿🇦", "Ghana": "🇬🇭",
    "Australia": "🇦🇺", "Serbia": "🇷🇸", "Jamaica": "🇯🇲", "Venezuela": "🇻🇪",
    "Austria": "🇦🇹", "Rumania": "🇷🇴", "Honduras": "🇭🇳", "Togo": "🇹🇬",
    "Nueva Zelanda": "🇳🇿", "Kenia": "🇰🇪", "Grecia": "🇬🇷", "Panamá": "🇵🇦",
}
