...
# ══════════════════════════════════════════════════════════════════════════════
# SELECTORES EN EL ÁREA PRINCIPAL
# ══════════════════════════════════════════════════════════════════════════════
...
with col_visita:
    ...
    equipo_visita   = st.selectbox("✈️ Equipo Visitante", opciones_visita, index=0)
...
if predecir_btn:
    ...
    with c1:
        ...
        st.markdown(f"""<div class="prob-card" style="border-color:{col}44">
            <h1 style="color:{col}">{pred['prob_local']*100:.1f}%</h1>
            <p>🏠 Victoria {equipo_local}</p></div>""", unsafe_allow_html=True)
    ...
    with c3:
        ...
        st.markdown(f"""<div class="prob-card" style="border-color:{col}44">
            ...
            <p>✈️ Victoria {equipo_visita}</p></div>""", unsafe_allow_html=True)
    ...
    with f1:
        ...
        st.markdown(dots_l if dots_l else "_Sin datos_", unsafe_allow_html=True)
    with f2:
        st.markdown(f"**{equipo_visita}**")
        dots_v = forma_html(df, equipo_visita, n=6)
        st.markdown(dots_v if dots_v else "_Sin datos_", unsafe_allow_html=True)
    ...
    <div style="text-align:center;padding:60px 20px;color:#8892b0">
        ...
        <h2 style="color:#ccd6f6">Selecciona liga y equipos arriba, luego presiona 🔮 Predecir</h2>
        <br>
        <p>📊 Forma reciente &nbsp;·&nbsp; ⚽ Promedio de goles &nbsp;·&nbsp; 🔁 Historial directo</p>
